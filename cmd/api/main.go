...
// (без учета перерывов на поесть, тренировкой в спортзале, возможное время прокрастенирования)
...
// Собрал все воедино, заставил работать, как нужно - 2 часа
...
//		(так как многие функцию содержать одно и то же поведение,

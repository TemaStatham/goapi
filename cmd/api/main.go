...
// 1. Запуск бд
// 	Нужен docker и утилита migrate
...
//		забыл написать про саморазвитие, как бэк-программиста
//	)
...
//
// 4 День - Проверка работы, исправление недоделок.
//
...
//		(так как многие функции содержат одно и то же поведение,
//		либо я не смог реализовать некоторые тесты, так как утонул в ошибках, и ничего не понял)
//
//	ИСПРАВЛЕНО (по крайней мере сегодня утром не было)
...
//
//	ИСПРАВЛЕНО (postman то же пойдет)
